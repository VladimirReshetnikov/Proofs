...
\texttt{Calculus.v}: weakening, the deduction
...
extension of any consistent set. This needs an enumeration of all formulas;
\texttt{Fol.v} builds one from Cantor's pairing function and proves it
surjective:
