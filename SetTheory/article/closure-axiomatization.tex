...
The formalization lives in the repository's \texttt{SetTheory/} directory, in
seven Rocq/Coq source files organized as a small library (see the
...
The development is seven Rocq/Coq files under \texttt{SetTheory/}, organized
