(**
  Natural existence (and, below, uniqueness) for the prime-factorization
  certificate, using MathComp's verified [prime_decomp].  This integration is
  deliberately isolated from the PA syntax development.
*)
