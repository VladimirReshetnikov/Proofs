...
theorem pathCheck_a15 : CertWork.pathCheck [a15] = true := by
  have hAll :
    ...
    have h00 : ((CertWork.after [a15]).assign a00).check = true := by
      ...
      exact pathCheck_a15_a00    have h01 : ((CertWork.after [a15]).assign a01).check = true := by
      rw [CertWork.assign_check_eq_pathAppend]
      exact pathCheck_a15_a01    have h02 : ((CertWork.after [a15]).assign a02).check = true := by
      rw [CertWork.assign_check_eq_pathAppend]
      exact pathCheck_a15_a02    have h03 : ((CertWork.after [a15]).assign a03).check = true := by
      rw [CertWork.assign_check_eq_pathAppend]
      exact pathCheck_a15_a03    have h04 : ((CertWork.after [a15]).assign a04).check = true := by
      rw [CertWork.assign_check_eq_pathAppend]
      exact pathCheck_a15_a04    have h05 : ((CertWork.after [a15]).assign a05).check = true := by
      rw [CertWork.assign_check_eq_pathAppend]
      exact pathCheck_a15_a05    have h06 : ((CertWork.after [a15]).assign a06).check = true := by
      rw [CertWork.assign_check_eq_pathAppend]
      exact pathCheck_a15_a06    have h07 : ((CertWork.after [a15]).assign a07).check = true := by
      rw [CertWork.assign_check_eq_pathAppend]
      exact pathCheck_a15_a07    have h08 : ((CertWork.after [a15]).assign a08).check = true := by
      rw [CertWork.assign_check_eq_pathAppend]
      exact pathCheck_a15_a08    have h09 : ((CertWork.after [a15]).assign a09).check = true := by
      rw [CertWork.assign_check_eq_pathAppend]
      exact pathCheck_a15_a09    have h10 : ((CertWork.after [a15]).assign a10).check = true := by
      rw [CertWork.assign_check_eq_pathAppend]
      exact pathCheck_a15_a10    have h11 : ((CertWork.after [a15]).assign a11).check = true := by
      rw [CertWork.assign_check_eq_pathAppend]
      exact pathCheck_a15_a11    have h12 : ((CertWork.after [a15]).assign a12).check = true := by
      rw [CertWork.assign_check_eq_pathAppend]
      exact pathCheck_a15_a12    have h13 : ((CertWork.after [a15]).assign a13).check = true := by
      rw [CertWork.assign_check_eq_pathAppend]
      exact pathCheck_a15_a13    have h14 : ((CertWork.after [a15]).assign a14).check = true := by
      rw [CertWork.assign_check_eq_pathAppend]
      exact pathCheck_a15_a14    have h15 : ((CertWork.after [a15]).assign a15).check = true := by
      rw [CertWork.assign_check_eq_pathAppend]
      exact pathCheck_a15_a15
    rw [show (CertWork.after [a15]).used = 4 by decide,
