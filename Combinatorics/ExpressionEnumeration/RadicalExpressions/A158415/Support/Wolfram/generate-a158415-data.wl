(* Exact recurrence data for OEIS A158415.
   ...
   Run from the repository root with:
     ...
     wolfram -script Combinatorics/ExpressionEnumeration/RadicalExpressions/A158415/Support/Wolfram/generate-a158415-data.wl 11 summary
     wolfram -script Combinatorics/ExpressionEnumeration/RadicalExpressions/A158415/Support/Wolfram/generate-a158415-data.wl 11 table
     wolfram -script Combinatorics/ExpressionEnumeration/RadicalExpressions/A158415/Support/Wolfram/generate-a158415-data.wl 11 collisions
     wolfram -script Combinatorics/ExpressionEnumeration/RadicalExpressions/A158415/Support/Wolfram/generate-a158415-data.wl 11 routes
     wolfram -script Combinatorics/ExpressionEnumeration/RadicalExpressions/A158415/Support/Wolfram/generate-a158415-data.wl 12 lean-table
     wolfram -script Combinatorics/ExpressionEnumeration/RadicalExpressions/A158415/Support/Wolfram/generate-a158415-data.wl 12 adjacent
     wolfram -script Combinatorics/ExpressionEnumeration/RadicalExpressions/A158415/Support/Wolfram/generate-a158415-data.wl 12 lean-special
     wolfram -script Combinatorics/ExpressionEnumeration/RadicalExpressions/A158415/Support/Wolfram/generate-a158415-data.wl 12 lean-strict
     wolfram -script Combinatorics/ExpressionEnumeration/RadicalExpressions/A158415/Support/Wolfram/generate-a158415-data.wl 12 lean-range
     wolfram -script Combinatorics/ExpressionEnumeration/RadicalExpressions/A158415/Support/Wolfram/generate-a158415-data.wl 15 numeric-lean-membership
*)
...
printLeanMembership[n_Integer] := Module[{},
  If[n === 14,
    ...
    Print["  wolfram -script Combinatorics/ExpressionEnumeration/RadicalExpressions/A158415/Support/Wolfram/generate-a158415-data.wl 14 numeric-lean-membership"];
    Print["-/"];
    Print[""];
    Print["namespace Values14Route"];
    Print[""];
  ...
  Print["Regenerate with:"];
  Print["  wolfram -script Combinatorics/ExpressionEnumeration/RadicalExpressions/A158415/Support/Wolfram/generate-a158415-data.wl 15 numeric-lean-membership"];
  Print["-/"];
  Print[""];
  Print["namespace Values15Route"];
  Print[""];
...
printLeanIntervalOrderModule[n_Integer] := Module[
  ...
  tableModule = "A158415.Certificates." <> If[n === 14, "N14", "N15"] <> ".Table";
  Print["import ", tableModule];
  Print["import A158415.IntervalCert"];
  Print[""];
  Print["/-!"];
...
writeGenerated[n_Integer, name_String, expr_] := Module[{path, stream},
  path = FileNameJoin[{
    "Combinatorics", "ExpressionEnumeration", "RadicalExpressions", "A158415",
    "Support", "Wolfram", "generated",
