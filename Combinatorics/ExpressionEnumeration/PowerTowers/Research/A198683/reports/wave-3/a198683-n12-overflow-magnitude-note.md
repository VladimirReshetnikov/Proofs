...
```powershell
python .\Combinatorics\ExpressionEnumeration\PowerTowers\Research\A198683\computations\python\diagnose_overflow_magnitude.py --top 12
```
...
```powershell
python .\Combinatorics\ExpressionEnumeration\PowerTowers\Research\A198683\computations\python\trace_dp_expression.py --n 11 --index 57 --dps 260
```
