...
5. **In-repo, in-language.** No subprocess to a Wolfram kernel, no
   ...
   `Combinatorics/ExpressionEnumeration/PowerTowers/Research/A198683/computations/python/`. The certificate is
   self-contained.
...
```
+---------------------------------------------------------------+
| Application: PowerTowers/Research/A198683/computations/python/     |
...
### Phase B — Application layer in `Combinatorics/ExpressionEnumeration/PowerTowers/Research/A198683/computations/python/`
...
11. Produce a result report under `Combinatorics/ExpressionEnumeration/PowerTowers/Research/A198683/reports/` recording
