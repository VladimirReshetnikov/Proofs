...
python .\Combinatorics\ExpressionEnumeration\PowerTowers\Research\A198683\computations\python\diagnose_tol.py --dps 260
```
...
```powershell
python .\Combinatorics\ExpressionEnumeration\PowerTowers\Research\A198683\computations\python\diagnose_levels.py --dps 180 --n-max 11
```
...
```powershell
python .\Combinatorics\ExpressionEnumeration\PowerTowers\Research\A198683\computations\python\diagnose_dedup.py --dps 260 --canonical-tol-frac 3
python .\Combinatorics\ExpressionEnumeration\PowerTowers\Research\A198683\computations\python\diagnose_pairs.py --dps 260
```
