...
(see `Combinatorics/ExpressionEnumeration/PowerTowers/Research/A198683/reports/wave-3/a198683-post-wave2-synthesis.md`).
...
* `NearOneSplit : nearOne25 ≠ nearOne1404`.  An inequality between two
  ...
  Rocq/Coq development (`Combinatorics/ExpressionEnumeration/PowerTowers/Coq/A198683/N12/N12Bounds.v`) certifies the same
...
`Combinatorics/ExpressionEnumeration/PowerTowers/Research/A198683/reports/wave-3/a198683-numerics-interval-feasibility.md` is
