...
/-!
The historical intermediate `n = 7` bounds below are retained as named
corollaries of the final bound pair; their original standalone certificates
were superseded by `a198683_seven_le_thirty_four` and
`thirty_four_le_a198683_seven`.
-/
