...
proves canonical value theorems `a002845_one` through `a002845_six`. It
...
`a002845Sparse_twenty_two`. These are intentionally not treated as primary
OEIS value theorems until the sparse backend is proved equivalent to the
canonical logarithm value set.
